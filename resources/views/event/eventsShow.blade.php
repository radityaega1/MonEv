                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                <div class="p-6 text-gray-900 dark:text-gray-100">
                                    ...
                                    <div class="flex space-x-2">From:
                                        <span class="mx-2">{{ $event->start_date}}</span>
                                        <span class="mx-2">{{ $event->end_date}}</span>
                                    </div>
                                    ...
                                    <div class="flex justify-start">
                                        <div class="mb-4 flex items-center text-sm font-medium">
                                            ...
                                            <div class="text-yellow-700">{{ $event->province->name }}, {{ $event->district->name }}</div>
                                        </div>
                                ...
                                <div class="flex flex-col p-4">
                                    ...
                                    <div class="flex space-x-4 mt-6 bg-white dark:bg-gray-800 p-2 rounded-md">
                                        <span>
                                        ...
                                        <div class="flex flex-col">
                                            <span class="text-2xl">{{ $event->editor->username }}</span>
                                            <span class="text-2xl">{{ $event->editor->email }}</span>
                                        </div>
                                    </div>
                                </div>
                                @auth
                                    <div class="container d-flex justify-content-center align-items-center w-50 mt-6 bg-slate-200 p-4 rounded-md">
                                        <div class="">
                                            <form method="POST" action="{{ route('events.comments', $event->id) }}" class="flex justify-between space-x-2">
                                                @csrf
